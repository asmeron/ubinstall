...
* В этот каталог симлинками подключаются каталоги доступных для установки клиенту систем;
...
В корне накопителя содержится каталог all_repository, доступных для установки, редакций дистрибутивов. Папки имеют названия по имени, версии ОС. Например, UBLinux Adara Server AR.01. В этих папках кроме файла os-release присутствуют файлы-модули ОС и файл key-license. Файл key-license необходим для процедуры сетевой установки системы и получения обновлений для системы.
