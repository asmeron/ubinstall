...
#### 3. Извлечь данные: дата окончания лицензии, тип лицензии, статус активации, персональный идентификатор;
...
#### 5. Если статус активации равен "activated", сравниваем значения данных hostid со значением парраметра hid в файл-схеме json.
...
#### 5. Если статус активации равен "unactivated", формируем ответ клиенту, в котором содержится предупреждение;
...
#### 6. Проверяем, какие типы лицензий доступны;
Доступные типы лицензии берутся из значений "type".
#### 7. Запускается *процедура формирования каталога репозитория и ответ клиенту*, в котором содержатся данные для доступа к репозиторию.

### Процедура формирования каталога репозитория и ответ клиенту
