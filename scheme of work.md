...
Меню формируется из результатов обработки скрипта, который обходит папки, с редакциями ОС и проверятет в них наличие файловkey-license, получая названия ОС из значения переменной PRETTY_NAME.  
