...
ID_LIKE=arch
PRETTY_NAME="UBLinux Server AR.19 (Adromeda)"
BUILD_ID="02.10.2019"
ANSI_COLOR="1;34"
...
ID=ublinux
ID_LIKE=archlinux
PRETTY_NAME="UBLinux Adara Server AR.1902 (Adromeda)"
VERSION_ID="Arc.01"
HOME_URL="http://ublinux.com/"
UBLINUX_CODENAME=andromeda
```
```
NAME="UBLinux Adara"
VARIANT="Desktop Enterprise"
